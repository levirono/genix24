<template>
  <div>
    <h2 class="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-emerald-500">Admin Users</h2>
    ...
    <table v-else class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      ...
      <tbody>
        <tr v-for="user in users" :key="user.id" class="border-b border-gray-100 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-gray-700">
